...
Phase 5-N4D-D-B0 已完成本地文档实现与验证。起始基线为
`3d878a9a2dc1c3d2002415e7729ff9d56dc3053a`，分支为 `main`。本阶段只修改
授权 Markdown，没有修改生产代码、测试、配置、依赖、Registry、Outbound、
Schema、Backup、Docker、Compose 或 CI。
...
```text
Extract repository-derived provider evidence
```
