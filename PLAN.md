...
维护与迁移：H1 数据库版本预检、H2 显式迁移框架已完成，尚未发布
```
...
- Phase 2-H1：数据库版本记录与升级预检（已完成，尚未发布）
- Phase 2-H2：显式 migration 框架与升级 dry-run（已完成，尚未发布）
- Phase 2-H3：升级前备份提示
- Phase 2-H4：启动时结构检查
...
- 数据库版本记录与升级预检（H1 已完成，尚未发布）
- 显式 migration 框架与升级 dry-run（H2 已完成，尚未发布）
- 升级前备份提示
- 启动时结构检查
...
```text
Phase 2-F4：数据维护前安全提示收尾，或 Phase 2-H3：升级前备份提示增强
目标版本：后续小版本
```
...
- Phase 2-H1 已完成 schema 版本记录、旧库基线预检、版本高低检查和只读状态展示
- Phase 2-H2 已完成空生产注册表、连续路径解析、只读 dry-run 和显式原子升级框架
- 下一步可以回到数据维护前安全提示收尾，或继续增强升级前备份与启动结构检查
