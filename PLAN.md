...
产品功能重启：Phase 3-A1 至 A6 已随 v1.0.5 发布；Phase 3-B1 / B2 已随 v1.0.6 发布；Phase 3-B3 已完成并位于 Unreleased；Phase 3-B4 开发中
```
...
当前开发状态：Phase 3-B4 位于 Unreleased，main 保持应用版本 1.0.6 与 Schema 2
WSL 验收：已完成
