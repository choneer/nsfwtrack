...
目标：在真实目标主机投入真实数据前完成一次操作验收，不开发功能。
...
- Phase 2-K1 已确认没有真实 TODO、占位路由或失效入口，并将剩余工作限定为 K2 / K3
- K2 / K3 不涉及外部源、复杂权限、推荐系统、schema 版本或新增依赖
