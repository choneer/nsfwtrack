...
当前开发状态：Phase 5-N4D-C Provider Package 绑定与离线激活门禁已完成；应用仍为 `1.1.0`、Schema 为 4、Backup 为 `nsfwtrack.backup.v2`；Production Registry 为空，无真实 Provider，synthetic packages 仅位于 tests。
