...
设置中心：G1 基础设置中心、G6 危险操作偏好已完成，尚未发布
```
...
```text
Phase 2-F4：数据维护前安全提示收尾，或 Phase 2-H1：数据库版本记录
目标版本：后续小版本
```
...
- 下一步可以回到数据维护前安全提示收尾，或进入轻量维护 / 迁移阶段
