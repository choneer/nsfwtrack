...
## 当前状态（v1.0.6 已发布，Phase 4-R3 发布候选最终验收已完成）

当前稳定版与最新 Release：`v1.0.6`。Phase 3-B1 / B2 已正式发布，
Phase 3-B3 / B4 / B5 / B6 / C1 / C2 / C3 / C4 / C5 与 D1 最终集成审查均已完成并位于 Unreleased；Phase 4-A1 / A2 / M1 / M2 / M3 / M4 / M5、Phase 4-R1 / R1D、Phase 4-R2C1、Phase 4-R2 和 Phase 4-R3 均已完成。应用内部版本为 `1.1.0`，候选已冻结；Schema 保持 `3`，正式稳定版仍为 `v1.0.6`。
