...
## 当前状态（v1.0.6 已发布，Phase 4-R3 发布候选准备已完成）

当前稳定版与最新 Release：`v1.0.6`。Phase 3-B1 / B2 已正式发布，
Phase 3-B3 / B4 / B5 / B6 / C1 / C2 / C3 / C4 / C5 与 D1 最终集成审查均已完成并位于 Unreleased；Phase 4-A1 / A2 / M1 / M2 / M3 / M4 / M5、Phase 4-R1 / R1D、Phase 4-R2C1 corrective 和 Phase 4-R2 发布候选验收均已完成。Phase 4-R3 已准备应用内部版本 `1.1.0` 发布候选，Schema 保持 `3`，正式稳定版仍为 `v1.0.6`。
...
- [ ] Phase 4-R3：云端复核和 Hermes 发布候选独立验收待完成
- [ ] 发布：`v1.1.0` 尚未获得正式发布授权；不创建 tag/Release，不部署 N100
