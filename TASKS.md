...
## 当前状态（Phase 5-N4D-C Provider Package 离线门禁已完成）
...
Provider Package/Evidence/Binding 的 all-or-nothing 离线激活门禁。N4D-D/N4E/
N4F/N4G 分别等待完整 Provider Approval。
...
#### Phase 5-N4D-D - 首个影视元数据 Provider Package
